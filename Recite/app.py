...
class ReciteWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        progress_row.addWidget(self.speed_slider)
        ...
        self.controls_separator.setFrameShape(QFrame.Shape.VLine)
        ...
        controls.addWidget(self.controls_separator)
        controls.addSpacing(8)
        controls.addWidget(self.continuous_button)
        controls.addWidget(self.stop_continuous_button)
        controls.addStretch(1)
        controls.addWidget(self.repeat_label)
